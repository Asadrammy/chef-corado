...
interface EngagingOpportunitiesProps {
  requests: Array<{
    id: string
    title: string
    budget: number
...
export function EngagingOpportunities({ requests, availableRequestsCount }: EngagingOpportunitiesProps) {
  if (availableRequestsCount === 0) {
    return (
      <Card className="bg-gradient-to-br from-blue-50 to-purple-50 border-0 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
        <CardContent className="p-16">
          <div className="text-center max-w-2xl mx-auto space-y-8">
            {/* Large Icon */}
            <div className="w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto shadow-lg">
      ...
      <CardHeader className="pb-8">
        <CardTitle className="text-2xl font-bold text-gray-900 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg font-normal mt-1">
