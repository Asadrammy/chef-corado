...
import { FileText, Clock, MapPin, DollarSign, Send, Calendar, TrendingUp, Users, ArrowRight } from "lucide-react"
...
export function AvailableOpportunities({ requests, availableRequestsCount }: AvailableOpportunitiesProps) {
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-md mx-auto">
              Expand your service area to reach more clients or check back later for new opportunities
            </p>
        ...
        <div className="space-y-4">
          {requests.slice(0, 3).map((request) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              ...
              <div className="relative bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-gray-700/60 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    {/* Budget highlight */}
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 px-3 py-2 rounded-xl border border-green-200 dark:border-green-800">
