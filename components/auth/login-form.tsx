...
export function LoginForm() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[36px] border border-[rgba(209,218,232,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(249,251,254,0.94))] p-6 shadow-[0_30px_80px_rgba(15,23,42,0.12)] md:p-8">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-4">
            ...
            <div className="space-y-2.5">
              <h1 className="text-[2rem] font-semibold tracking-[-0.07em] text-[#0f172a] md:text-[2.6rem] md:leading-[0.96]">Welcome back</h1>
              <p className="max-w-sm text-sm leading-6 text-[#667085] md:text-[15px]">
      ...
      <div className="relative mt-8 space-y-6">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div className="space-y-2.5">
            ...
            <Input
              ...
              className="h-13 rounded-[18px] border border-[#d7dfeb] bg-[#ffffff] px-4 text-[15px] text-[#0f172a] shadow-[0_1px_2px_rgba(16,24,40,0.03)] transition-all duration-200 placeholder:text-[#98a2b3] hover:border-[#c5d0df] focus-visible:border-[#2159d6] focus-visible:ring-[4px] focus-visible:ring-[rgba(33,89,214,0.12)]"
            />
            {fieldErrors.email && (
        ...
        <div className="border-t border-[rgba(215,223,235,0.92)] pt-5 text-center text-sm text-[#667085]">
