  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-6 text-muted-foreground">Boutique venues, event spaces, residences, studios, members' rooms, and hospitality locations suited to intimate dining experiences.</p>
      </div>
    </PublicContentPage>
  );
}
