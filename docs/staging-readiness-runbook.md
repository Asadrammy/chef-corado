...
RESEND_FROM_EMAIL=ChefaChef <notifications@chefachef.co.uk>
...
Resend:
- Use a verified sender authorized for `notifications@chefachef.co.uk` or an approved staging sender.
